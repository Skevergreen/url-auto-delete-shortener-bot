...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://NewEnox:NewEnox@cluster0.jqzzp.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "NewEnox")
